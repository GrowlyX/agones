...
containers can make this work. Check your CNI for compatibility before relying on this, and otherwise keep any
container that needs a `GameServer` port in `containers`.
{{% /alert %}}
